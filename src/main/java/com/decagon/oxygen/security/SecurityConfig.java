...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeRequests().antMatchers("/api/auth","/api/user/signup","/api/oauth2/callback").permitAll()
    ...
    public FilterRegistrationBean<CorsFilter> corFilter() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:3000/", "google.com","facebook.com"));
